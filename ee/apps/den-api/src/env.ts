...
const EnvSchema = z.object({
  ...
  RENDER_WORKER_ORCHESTRATOR_VERSION: z.string().optional(),
  RENDER_WORKER_SERVER_VERSION: z.string().optional(),
  RENDER_WORKER_OPENCODE_VERSION: z.string().optional(),
