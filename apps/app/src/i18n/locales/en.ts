 ...
 * Professional terms (Skills, Plugins, Commands, Sessions, OpenCode, OpenPackage) are NOT translated; the app/brand name is injected at runtime via the {appName} token
 */
...
export default {
  ...
  "app.plugins_hint_readonly": "{appName} server is read-only for plugins.",
  "app.reload_later": "Later",
  "app.reload_now": "Reload now",
  "app.reload_stop_tasks": "Reload & Stop Tasks",
  "app.skills_hint_readonly": "{appName} server is read-only for skills. Add a host token in Advanced to enable installs.",
  ...
  "config.reload_availability_hint": "Reloading is only available for local workers or connected {appName} servers.",
  ...
  "config.server_needed_hint": "{appName} server connection needed to sync skills, plugins, and commands.",
  "config.server_section_desc": "Connect to an {appName} server. Use the URL plus a collaborator or owner token from your server admin.",
  "config.server_section_title": "{appName} server",
  ...
  "config.server_sharing_title": "{appName} server sharing",
  "config.server_url_hint": "Use the URL shared by your {appName} server. Local desktop workers reuse a persistent high port in the 48000-51000 range.",
  "config.server_url_input_label": "{appName} server URL",
  "config.server_url_label": "{appName} Server URL",
  ...
  "context_panel.authorized_folders_no_access": "Connect to a writable {appName} server workspace to edit authorized folders.",
  "context_panel.browse_button": "Browse",
  "context_panel.config_access_unavailable": "{appName} server config access is unavailable for this workspace.",
  "context_panel.config_read_only": "{appName} server is connected read-only for workspace config.",
  ...
  "context_panel.server_disconnected": "{appName} server is disconnected.",
  ...
  "context_panel.writable_workspace_required": "A writable {appName} server workspace is required to update authorized folders.",
  ...
  "dashboard.chooser_remote_desc": "Attach to a self-hosted {appName} worker using a URL and access token.",
  ...
  "dashboard.create_remote_custom_subtitle": "Attach to a self-hosted {appName} worker.",
  "dashboard.create_remote_custom_title": "Connect custom remote",
  "dashboard.create_remote_workspace_confirm": "Add Workspace",
  "dashboard.create_remote_workspace_subtitle": "Save an {appName} server as a workspace.",
  ...
  "dashboard.create_shared_subtitle_signed_out": "Sign in to {appName} Cloud to access workers shared with your organization.",
  ...
  "dashboard.edit_remote_workspace_subtitle": "Update the {appName} server details for this workspace.",
  ...
  "dashboard.remote_server_details_hint": "Attach to a self-hosted {appName} worker.",
  ...
  "den.auto_reconnect_hint": "Finish auth in your browser and {appName} will reconnect here automatically.",
  ...
  "den.cloud_section_title": "{appName} Cloud",
  "den.cloud_sleep_hint": "Sign in to {appName} Cloud to keep your tasks alive even when your computer sleeps.",
  "den.cloud_signed_in_desc": "You are signed in and ready to use {appName} Cloud.",
  "den.cloud_workers_hint": "Open workers directly into {appName} using the same remote-connect flow the app already uses elsewhere.",
  ...
  "den.error_no_token": "Desktop sign-in completed, but {appName} Cloud did not return a session token.",
  "den.error_open_worker": "Failed to open {name} in {appName}.",
  "den.error_open_worker_fallback": "Failed to open {name}.",
  "den.error_paste_valid_code": "Paste a valid {appName} sign-in link or one-time sign-in code.",
  "den.error_signin_failed": "Failed to complete {appName} Cloud sign-in.",
  ...
  "den.signin_link_hint": "If your browser doesn't bounce back into {appName} automatically, paste the sign-in link or one-time code from {appName} Cloud here.",
  "den.signin_link_label": "Sign-in link or one-time code",
  "den.signin_link_placeholder": "openwork://den-auth?... or pasted code",
  "den.signin_title": "Sign in to {appName} Cloud",
  "den.signing_in": "Finishing {appName} Cloud sign-in...",
  ...
  "den.status_browser_signin": "Finish signing in in your browser to connect {appName}.",
  "den.status_browser_signup": "Finish account creation in your browser to connect {appName}.",
  "den.status_cloud_signed_in_as": "Connected {appName} Cloud as {email}.",
  "den.status_cloud_signin_done": "Connected {appName} Cloud.",
  ...
  "den.status_opened_worker": "Opened {name} in {appName}.",
  "den.status_signed_in_as": "Signed in as {email}.",
  "den.status_signed_out": "Signed out and cleared your {appName} Cloud session on this device.",
  "den.sync": "Sync",
  ...
  "identities.connect_server_desc": "Identities are available when you are connected to an {appName} host.",
  "identities.connect_server_title": "Connect to an {appName} server",
  ...
  "identities.reconnect_failed": "Reconnect failed. Check {appName} URL/token and try again.",
  ...
  "mcp.toggle_requires_server": "Connect to an {appName} server to enable or disable MCPs.",
  ...
  "mcp.apps_subtitle": "Connect your favorite tools so {appName} can use them on your behalf.",
  "mcp.apps_title": "Apps",
  ...
  "mcp.auth.reload_notice": "For this to take effect, {appName} needs to refresh the worker service. This can interrupt a running session.",
  "mcp.auth.reload_remote_confirm": "For this to take effect, {appName} needs to refresh the worker service. This might stop your running session. Continue?",
  ...
  "mcp.auth.step2_title": "Authorize {appName}",
  ...
  "mcp.login_unavailable": "This app does not support sign-in from {appName}.",
  ...
  "mcp.quick_connect_openwork_cloud_title": "{appName} Cloud Control",
  "mcp.quick_connect_openwork_ui_desc": "Let agents see and drive the {appName} app. Navigate sessions, type into the composer, open settings. Try: \"Take a snapshot of what I see\" or \"Create a new session and type hello.\"",
  "mcp.quick_connect_openwork_ui_title": "{appName} UI Control",
  ...
  "welcome.folder_explanation": "This folder becomes your workspace. {appName} will be able to:",
  ...
  "welcome.folder_drop_hint": "Drop files in anytime and {appName} can pick them up.",
  "plugins.add": "Add",
  ...
  "session.share_local_host_not_ready": "Local {appName} host is not ready yet.",
  "session.share_missing_host_url": "Missing {appName} host URL.",
  "session.share_missing_token": "Missing {appName} token.",
  ...
  "session.share_openwork_workers_only": "Share service links are available for {appName} workers.",
  ...
  "settings.capabilities_title": "{appName} server capabilities",
  ...
  "settings.custom_binary_hint": "Use this to point {appName} at a local OpenCode build",
  ...
  "settings.debug_openwork_server_version": "{appName} server: {version}",
  ...
  "settings.enable_exa_desc": "Applies the next time OpenCode is started by {appName}. Off by default.",
  ...
  "settings.feedback_title": "Help shape {appName}",
  ...
  "settings.open_deeplink_desc": "Paste an {appName} deeplink or share URL to open it.",
  ...
  "settings.opencode_engine_sidecar_desc": "Local OpenCode process managed by {appName}.",
  ...
  "settings.openwork_config_sidecar_desc": "Local {appName} server (Bun) that hosts approvals, audit, and OpenCode lifecycle.",
  "settings.openwork_diagnostics_title": "{appName} server diagnostics",
  "settings.openwork_server_desc": "Session control plane for app sync, workers, and remote",
  "settings.openwork_server_label": "{appName} server",
  ...
  "settings.quit_hint": "{appName} quits immediately after cleanup so the next launch starts from a blank local state for this mode.",
  ...
  "settings.reconnect_server_failed": "Failed to reconnect {appName} server.",
  "settings.reconnected": "Reconnected to {appName} server.",
  ...
  "settings.reset_app_data_description": "More aggressive. Clears {appName} cache + app data.",
  "settings.reset_app_data_title": "Reset app data",
  "settings.reset_app_data_warning": "Clears {appName} cache and app data on this device.",
  ...
  "settings.reset_confirmation_hint": "Type {resetWord} to confirm. {appName} will restart.",
  ...
  "settings.reset_onboarding_description": "Clears {appName} preferences and restarts the app.",
  "settings.reset_onboarding_title": "Reset onboarding",
  "settings.reset_onboarding_warning": "Clears {appName} local preferences and workspace onboarding markers.",
  ...
  "settings.reset_openwork_title": "Reset {appName} + OpenCode state",
  ...
  "settings.restart_blocked_message": "The update is ready, but {appName} will wait until your active tasks finish before restarting. You can also stop them manually.",
  "settings.restart_failed": "Restart failed. Check logs and try again.",
  "settings.restart_opencode": "Restart OpenCode",
  "settings.restart_openwork_server": "Restart {appName} server",
  ...
  "settings.services_section_desc": "Local services that power this {appName} session. Each service has its own restart and logs.",
  ...
  "settings.recovery_section_desc": "Roll back state without quitting {appName}.",
  ...
  "settings.runtime_desc": "Status for your local engine and {appName} server.",
  ...
  "settings.tab_description_appearance": "Adjust how {appName} looks across desktop, system theme, and app frame.",
  ...
  "settings.tab_description_general": "Connect providers, choose the default model, authorize folders, and control the selected {appName} workspace plus its runtime connection.",
  ...
  "settings.environment.override_hint": "Environment variables set before {appName} starts take precedence over values saved here.",
  ...
  "settings.environment.apply_confirm_body": "{appName} will restart local agents so they can use the latest environment. Running local tasks may stop.",
  "settings.environment.apply_no_local_workspace": "{appName} is not connected to a local workspace.",
  ...
  "settings.environment.apply_refresh_failed": "Changes are active, but {appName} status did not refresh. Reopen the app if it looks stale.",
  ...
  "settings.environment.validation_reserved": "OPENWORK_ and OPENCODE_ names are managed by {appName}/OpenCode.",
  ...
  "settings.updates_desc": "Keep {appName} up to date.",
  ...
  "share_skill_destination.connect_remote_hint": "Attach an {appName} host, then choose it from the list to import this skill.",
  ...
  "skills.add_openwork_hub": "Add {appName} Hub",
  ...
  "skills.cloud_org_fallback": "{appName} Cloud",
  "skills.cloud_org_load_failed": "Failed to load organization skills.",
  "skills.cloud_refresh": "Refresh team skills",
  "skills.cloud_section_subtitle": "Skills shared with you through {appName} Cloud — including team skill hubs you can access.",
  ...
  "skills.cloud_sign_in_hint": "Sign in to {appName} Cloud to browse team and org skills.",
  ...
  "skills.host_only_error": "Skill management requires a local workspace or connected {appName} server.",
  ...
  "skills.share_option_team_desc": "Add this skill to your active {appName} Cloud organization.",
  ...
  "skills.share_team_permissions_intro": "Upload this skill to your active {appName} Cloud organization and decide who can see it.",
  ...
  "skills.share_team_sign_in_hint": "{appName} Cloud opens in your browser. Return here after signing in.",
  ...
  "status.limited_hint": "Reconnect to restore full {appName} features",
  ...
  "status.openwork_ready": "{appName} Ready",
  ...
  "system.reload_body_default": "{appName} detected changes that require reloading the OpenCode instance.",
  "system.reload_body_mcp": "OpenCode loads MCP servers at startup. Reload the engine to activate the new connection.",
  "system.reload_body_mixed": "{appName} detected OpenCode configuration changes. Reload the engine to apply them.",
  ...
  "workspace_list.remote_worker_unavailable_hint": "{appName} can't load tasks from this worker until the connection is fixed.",
